...
`hidden/custom_ui/` and `.codex/skills/local_custom_ui/SKILL.md`.
...
For CUA-Gym Hub mock websites, load `.codex/skills/mock_websites/SKILL.md` and
...
For local custom UI, load `.codex/skills/local_custom_ui/SKILL.md` and follow
...
`.codex/skills/mock_websites/REWARD_SKILL.md` and use admin-token
...
For local custom UI, load `.codex/skills/local_custom_ui/SKILL.md` and use
